...
export const publisher: BatchLoadFn<number, PublisherEntity | null> = async (
    ...
    return mappingResultForDataLoader(publishersIds, result, "publisherId", false);
};

export const publishersFromCountry: BatchLoadFn<number, PublisherEntity[] | null> = async (
